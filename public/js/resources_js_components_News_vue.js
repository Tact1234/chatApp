...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
      ...
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return axios.get("/getNews").then(function (res) {
                Object.keys(res.data).forEach(function (key) {
                  _this.items[key] = res.data[key].channel.item;

                  _this.items[key].forEach(function (item) {
                    var date = new Date(item.pubDate);
                    item.pubDate = _this.getFormatDate(date);
                  });
                });
              });
  ...
  methods: {
    setItemKey: function setItemKey(value) {
...
var render = function() {
  ...
  return _c(
    "v-list",
    [
      _c("v-subheader", [_vm._v("GOOGLE NEWS")]),
      _vm._v(" "),
      _c(
        "v-tabs",
        {
        ...
        _vm._l(_vm.topics, function(topic, i) {
          return _c("v-tab", {
            key: i,
            domProps: { textContent: _vm._s(topic) },
            on: {
              click: function($event) {
                return _vm.setItemKey(topic)
              }
            }
          })
        }),
      ...
      _c(
        "v-list-item-group",
        _vm._l(_vm.items[_vm.keyTopics], function(item, i) {
          return _c(
            "v-list-item",
            { key: i, attrs: { href: item.link } },
            [
              _c(
                "v-list-item-content",
                [
                  _c("v-list-item-subtitle", {
                    domProps: { textContent: _vm._s(item.pubDate) }
                  }),
                  _vm._v(" "),
